...
// Call this to init push notifications
PushNotification.prototype.init = function(successCallback, errorCallback, config) {
    ...
    cordova.exec(successCallback, errorCallback, "PushPlugin", "init", [config]);
};
